...
# Configuration
REPO_URL="https://github.com/euchrogene/Localizer.git"
REPO_DIR="Localizer"
EXE_FILE="Localizer"
PIPELINE_ENTRY="$EXE_FILE => A software to predict the subcellular localization of pathogen effector proteins (and plant proteins) within plant cells"
